...
const Nav = () => (
  <nav className="pt3 pt4-ns mb4 mb0-n5">
...
const Overlay = ({ showInfo, title, description, link }) => (
  <div
    ...
    style={{
      //do a test to see whether our showinfo state is true
      //if it is, we change the transform to none, otherwise -100%
...
//we can also write create components as classes.
//they give us more advanced funtionality and features
//such as the component lifestytle as well as react's built-in state
...
class Attraction extends React.Component {
  constructor(props) {
    ...
    //tell toggleinfo about this by using bind
    //otherwise things like setState won't work
  ...
  toggleInfo() {
    this.setState((prevState, props) => ({
      //here we invert our showInfo bool by using
      //prevState and the !
  ...
  closeInfo() {
    ...
    //access to the previous state, we're just foce setting
